...
<div class="flex items-center py-6">
	...
	<div>
		<Button size="sm" href="/settings/general">
			Edit
		</Button>
	</div>
</div>
...
<div class="py-16">
	...
	>
		...
		<!-- About -->
		<div
			class="px-4 py-4 shadow-sm ring-1 ring-gray-900/5 sm:rounded-lg sm:px-8 lg:col-span-2 lg:row-span-2 lg:row-end-2"
		>
			<dl class="text-sm leading-6">
				<div class="sm:pr-4">
					<dt class="font-semibold text-gray-900">About</dt>
					<dd class="mt-2 text-gray-500">This is a description about me.</dd>
				</div>
			</dl>
		</div>
	</div>

	<div class="bg-muted mt-4 rounded-md border border-gray-200 p-2 text-xs">
